...
//=========== Lu added for new chat widgetScroll to the bottom of the chats after new message has been added to chat ======
function scrollToBottomOfResultsBack() {

    var terminalResultsDivBack = document.getElementById("chats-back");
    terminalResultsDivBack.scrollTop = terminalResultsDivBack.scrollHeight;
}
